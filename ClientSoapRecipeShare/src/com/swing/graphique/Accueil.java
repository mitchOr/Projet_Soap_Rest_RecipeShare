		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addComponent(lblWelcomeOnRecipe, GroupLayout.PREFERRED_SIZE, 225, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblSearchByDate))
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(lblNameLast, GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE))
								.addGroup(groupLayout.createSequentialGroup()
									.addGap(33)
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
					...
					.addComponent(btnSeDconnecter, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
					.addGap(117))
		);
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblWelcomeOnRecipe)
