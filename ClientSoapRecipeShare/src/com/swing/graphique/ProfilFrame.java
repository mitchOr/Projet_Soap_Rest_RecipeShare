...
public class ProfilFrame extends JDialog {
	...
	public ProfilFrame(User user) {
			...
			gl_contentPanel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPanel.createSequentialGroup()
					...
					.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(labelFirstName, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING, false)
						.addComponent(textFieldBirthDay)
						.addComponent(textFieldfirstName, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE))
					.addPreferredGap(ComponentPlacement.RELATED, 115, Short.MAX_VALUE)
					.addComponent(labellastName)
					.addGap(18)
					.addComponent(textFieldLastName, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE)
					.addGap(99))
				.addGroup(gl_contentPanel.createSequentialGroup()
					.addGap(285)
		...
		edit(user.getId(),user.getFirstName(), user.getLastName(), user.getBirthDate());
