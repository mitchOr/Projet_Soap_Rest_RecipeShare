							...
							.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPanel.createSequentialGroup()
									.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
										...
										.addComponent(labelDateCreation)
										.addComponent(labeContent))
									.addGap(9)
									.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
										.addComponent(txtDateOfCreation, GroupLayout.PREFERRED_SIZE, 133, GroupLayout.PREFERRED_SIZE)
										.addComponent(txtAuthor, GroupLayout.PREFERRED_SIZE, 168, GroupLayout.PREFERRED_SIZE)))))
						.addGroup(gl_contentPanel.createSequentialGroup()
							.addGap(216)
							.addComponent(labelTitle, GroupLayout.PREFERRED_SIZE, 147, GroupLayout.PREFERRED_SIZE)))
